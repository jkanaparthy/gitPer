...
public class CaptureDenomResultFrame extends JFrame implements ActionListener {

	private static final long serialVersionUID = -4885473693139493938L;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CaptureDenomResultFrame frame = new CaptureDenomResultFrame();
